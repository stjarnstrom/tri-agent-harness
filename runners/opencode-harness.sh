...
#
# Usage:
#   ./runners/opencode-harness.sh "Build a project management tool"
#   ./runners/opencode-harness.sh "Build a DAW in the browser" 5
#   HARNESS_ON_MAX_ROUNDS=advance ./runners/opencode-harness.sh "..."
#
...
PROMPT="${1:?Usage: ./runners/opencode-harness.sh \"your product prompt here\" [max_qa_rounds]}"
MAX_QA_ROUNDS="${2:-3}"
HARNESS_MODEL="${HARNESS_MODEL:-anthropic/claude-sonnet-4-5}"
PROJECT_DIR="$(cd "$(dirname "$0")/.." && pwd)"
HARNESS_SOURCE="runners/opencode-harness.sh"
